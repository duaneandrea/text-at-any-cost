...
/**
 * Просто фунцкии собраны в класс для единообразия пока
 *
 * Class RarList
...
class RarList
{
	...
	// PECL-расширения rar.
	public static function rar_getFileList($filename)
	{
	...
	public static function rar_getFileTree($filename)
	{
		// Получаем список файлов и директорий
		$files = self::rar_getFileList($filename);
